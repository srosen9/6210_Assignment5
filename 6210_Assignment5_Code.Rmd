...
#looping through each species and adding the resulting search ids into the vector COI_search_ids
for (species in unique_species) {
  COI_search <- entrez_search(db = "nuccore",term = paste(value, "[ORGN] AND COI[GENE] AND SLEN[630:670]", sep = " ",))
  COI_search_ids <- append(COI_search_ids, COI_search$ids)
  }
